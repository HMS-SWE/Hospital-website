...
class ProfileServiceTest {
    ...
    void getDoctorProfile_returnsResponse_whenDoctorExists() {
        when(doctorRepository.findByUserId(2L)).thenReturn(Optional.of(mockDoctor));
    ...
    void getPatientProfile_returnsResponse_whenPatientExists() {
        when(patientRepository.findByUserId(3L)).thenReturn(Optional.of(mockPatient));
        ...
        verify(patientRepository, times(1)).findByUserId(3L);
