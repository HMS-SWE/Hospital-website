...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final List<RouteRoleRule> ROLE_RULES = List.of(
            ...
            new RouteRoleRule(new AntPathRequestMatcher("/api/specializations/**"), Set.of(Role.ADMIN)),
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        User user = null;
        boolean isSensitiveRoute = SENSITIVE_ROUTES.stream().anyMatch(m -> m.matches(request));
